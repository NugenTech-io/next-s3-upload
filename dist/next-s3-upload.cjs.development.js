...
var makeRouteHandler = function makeRouteHandler(options) {
  ...
  var route = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(req, res) {
      var missing, auth, config, bucket, filename, key, policy, sts, token;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              return _context.abrupt("return", res.status(401).json({
                error: 'Not authenticated to perform this action'
              }));
            ...
            case 11:
              ...
              key = options.key ? options.key(req, filename) : "next-s3-uploads/" + uuid.v4() + "/" + filename.replace(/\s/g, '-');
              policy = {
                Statement: [{
...
var missingEnvs = function missingEnvs() {
  var keys = ['S3_UPLOAD_KEY', 'S3_UPLOAD_SECRET', 'S3_UPLOAD_REGION', 'S3_UPLOAD_BUCKET'];
...
var getFileContents = function getFileContents(file) {
  return new Promise(function (resolve) {
    ...
    reader.onload = function (readEvent) {
      var _readEvent$target;

      resolve((_readEvent$target = readEvent.target) == null ? void 0 : _readEvent$target.result);
    };
...
var useS3Upload = function useS3Upload() {
  ...
  var uploadToS3 = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(file) {
      var filename, res, data, s3, blob, params, s3Upload, uploadResult;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return fetch("/api/s3-upload?filename=" + filename);
